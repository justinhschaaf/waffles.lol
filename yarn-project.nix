...
let
  ...
  yarnBin = fetchurl {
    url = "https://repo.yarnpkg.com/4.5.2/packages/yarnpkg-cli/bin/yarn.js";
    hash = "sha512-VwUE9nNJ7ybS2Gp2jcXsl26tl3qghrC7QjfpfV23rlxiD58ODt8+pQRyBQY/r/ECvyotd4ZkqU6qoQha1IP+Lg==";
  };
  ...
  cacheDrv = stdenv.mkDerivation {
    ...
    outputHash = "sha512-l+eKG5G4Lr0yTMnWmsk53DrdQ676rAmiBEjZmozcjK2Z/SDkto6ci00jzvvf2hJkt528hjHKjAH+KTKd3K6rdg==";
  };
